...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Glancoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"glancointools.com", "52.1.214.114"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"glancointools.com", "testnet-seed.glancointools.com"},
    {"xurious.com", "testnet-seed.gnc.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Glancoin is probably already running."), addrBind.ToString().c_str());
        else
